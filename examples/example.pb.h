...
class Ping : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:example.Ping)
 private:
...
class PingRes : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:example.PingRes)
 private:
...
inline void PingRes::set_mess(const char* value, size_t size) {
  set_has_mess();
  if (mess_ == &::google::protobuf::internal::kEmptyString) {
    mess_ = new ::std::string;
  }
